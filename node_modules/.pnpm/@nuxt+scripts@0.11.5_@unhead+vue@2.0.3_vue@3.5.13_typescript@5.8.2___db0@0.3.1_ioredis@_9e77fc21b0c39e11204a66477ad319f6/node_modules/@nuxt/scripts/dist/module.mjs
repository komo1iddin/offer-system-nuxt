import { useNuxt, useLogger, addDevServerHandler, tryUseNuxt, createResolver, addTemplate, logger as logger$1, defineNuxtModule, addImports, addComponentsDir, addPluginTemplate, addBuildPlugin, hasNuxtModule } from '@nuxt/kit';
